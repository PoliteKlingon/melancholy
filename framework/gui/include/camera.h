...
protected:
    ...
    glm::vec3 camera_center = glm::vec3(22.0f, 2.0f, -4.45f);
...
private:
    ...
    void update_eye_pos();
    void update_eye_position_data();
    void update_camera_center(float x, float y, float z);
